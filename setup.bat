...
nvidia-smi >nul 2>&1
if %errorlevel% equ 0 (
    echo GPU detecte - installation onnxruntime-gpu + cuDNN...
    "%PYTHON%" -m pip install onnxruntime-gpu nvidia-cudnn-cu12 nvidia-cublas-cu12 --quiet --no-warn-script-location
) else (
